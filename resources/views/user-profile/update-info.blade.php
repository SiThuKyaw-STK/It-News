    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateInfoModalLabel">Please Insert Your Phone & Address</h5>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('profile.update.info') }}" method="post" id="infoUpdate">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" value="{{old('phone')}}" placeholder="{{ auth()->user()->phone }}" >
                        @error("phone")
            ...
            <div class="modal-footer">
                ...
                <button form="infoUpdate" type="submit" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
